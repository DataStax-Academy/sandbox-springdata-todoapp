...
public class DseConfiguration {
    ...
    public DseCluster dseCluster() {
        ...
        // Long <-> Timestamp
        clusterConfig.withCodecRegistry(new CodecRegistry().register(new DseLongToTimeStampCodec()));
    ...
    public DseSession dseSession(DseCluster dseCluster) {
        ...
        try {
            DseSession dseSession = dseCluster.connect(keyspace);
            LOGGER.info(" + Connection established to DSE Cluster \\_0_/");
            return dseSession;
